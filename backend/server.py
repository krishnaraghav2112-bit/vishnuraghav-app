...
BOOKS = [
    {
        ...
        "publisher": "",
        "price": "₹220",
        "description": "उन भावनाओं की किताब है जो शब्दों से पहले मौन बन जाती हैं। यह प्रेम, पीड़ा और भीतर चलने वाले संवादों का एक शांत संग्रह है — जहाँ हर पृष्ठ ठहरकर पढ़े जाने की माँग करता है।",
        "excerpt": "यह पुस्तक उत्तर नहीं देती, बस इतना करती है कि पाठक अपने ही अनुभवों के थोड़ा और करीब आ सके।",
        "takeaways": [
    ...
    },
    {
        ...
        "publisher": "Co-author: Yatin Tyagi",
        "price": "₹220",
         "description": "मानसिक बेचैनी, overthinking और भीतर की अनदेखी लड़ाइयों की एक ईमानदार पड़ताल। जब मन अस्थिर हो, फैसले भारी लगें और ज़मीन डगमगाती लगे — तब यह किताब आपके साथ चुपचाप खड़ी रहती है।",
        "excerpt": "यह किताब किसी महान व्यक्ति की नहीं है। यह एक साधारण इंसान की है जो थक गया था — और भागने के बजाय रुक गया।",
        "takeaways": [
    ...
    },
    {
        ...
        "tagline": "बस कुछ पल और, फिर यह रात भी बीत जाएगी",
         "publisher": "A Practical Guide to the Overthinking Mind",
        "price": "₹270",
        "description": "मोटिवेशनल नारों की जगह यह किताब समझाती है कि विचार कैसे बनते हैं, मन क्यों बेवजह पीड़ा रचता है, और जागरूकता से इन patterns को कैसे तोड़ा जा सकता है। मनोविज्ञान, mindfulness और गहरी समझ का एक शांत संगम।",
        "excerpt": "किस रात की बात हुई है यहाँ? कहीं यह वह रात तो नहीं जिसे जीवन कहते हैं — और हम एक उलझन में उसे बीता देते हैं।",
        "takeaways": [
...
ASSESSMENT_QUESTIONS = [
    {"id": 1, "domain": "mood", "text": "I have felt sad or empty most of the time."},
    {"id": 2, "domain": "mood", "text": "I don't find joy in things I used to enjoy."},
    {"id": 3, "domain": "mood", "text": "It has felt hard to get out of bed and start my day."},
    {"id": 4, "domain": "mood", "text": "I have felt very tired without any real reason."},
    {"id": 5, "domain": "overthinking", "text": "The same thought keeps replaying in my mind again and again."},
    {"id": 6, "domain": "overthinking", "text": "I worry so much about the future that I can't enjoy the present."},
    {"id": 7, "domain": "overthinking", "text": "I keep recalling my past mistakes over and over."},
    {"id": 8, "domain": "self_worth", "text": "I feel I am not as good as others."},
    {"id": 9, "domain": "self_worth", "text": "I dismiss even my own achievements."},
    {"id": 10, "domain": "stress", "text": "I take too much stress over small things."},
    {"id": 11, "domain": "daily_functioning", "text": "My attention gets distracted easily."},
    {"id": 12, "domain": "daily_functioning", "text": "I find it harder to make decisions than before."},
    {"id": 13, "domain": "daily_functioning", "text": "My sleep has gotten worse than before."},
    {"id": 14, "domain": "relationships_purpose", "text": "I avoid meeting or talking to people."},
    {"id": 15, "domain": "relationships_purpose", "text": "I feel that no one truly understands me."},
    {"id": 16, "domain": "relationships_purpose", "text": "I feel my life lacks direction."},
    {"id": 17, "domain": "stress", "text": "I struggle to control my emotions."},
    {"id": 18, "domain": "stress", "text": "Stress is affecting my daily life."},
    {"id": 19, "domain": "relationships_purpose", "text": "Sometimes I feel my life has no purpose."},
    {"id": 20, "domain": "safety", "text": "In the past 2 weeks, have you had thoughts that life is not worth living, or thoughts of harming yourself?"},
]
